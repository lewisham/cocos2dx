...
void DBCCArmatureNode::registerSoundEventHandler(cocos2d::LUA_FUNCTION func){
    _armature->registerSoundEventHandler(func);
}
...
void DBCCArmatureNode::unregisterSoundEventHandler(){
    _armature->unregisterSoundEventHandler();
}
