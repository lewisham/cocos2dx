...
public:
    ...
    virtual DBCCArmatureNode* buildArmatureNode(const std::string &armatureName, const std::string &dragonBonesName,WorldClock* clock) const;
    ...
    virtual ITextureAtlas* loadTextureAtlas(const std::string &textureAtlasFile,
                                            const std::string &name = "");
    
    virtual ITextureAtlas* loadTextureAtlasFromPlist(const std::string &plist,const std::string &name);
    ...
    const std::string removeDBDataByKey(const std::string &name);
    
protected:
    DragonBonesData* getDragonBonesDataFromFile(const std::string &dragonBonesFile);
