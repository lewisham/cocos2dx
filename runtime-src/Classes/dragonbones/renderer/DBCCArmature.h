...
public:
    ...
    virtual void setAllGLParamState(cocos2d::GLProgramState *state);
#if (DRAGON_BONES_ENABLE_LUA == 1)
    ...
    virtual void registerSoundEventHandler(cocos2d::LUA_FUNCTION func);
    virtual void unregisterFrameEventHandler();
    virtual void unregisterAnimationEventHandler();
    virtual void unregisterSoundEventHandler();
#endif // DRAGON_BONES_ENABLE_LUA
