...
#include <dragonbones/renderer/DBCCRenderHeaders.h>
...
int lua_dragonbones_DBCCArmature_registerAnimationEventHandler(lua_State* tolua_S)
{
	...
	CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "registerAnimationEventHandler", argc, 1);
	return 0;
...
int lua_dragonbones_DBCCArmature_unregisterAnimationEventHandler(lua_State* tolua_S)
{
	...
	CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "unregisterAnimationEventHandler", argc, 0);
	return 0;
...
//+++++++++++++++++++++++++++++++++++++++++++++
int lua_dragonbones_DBCCFactory_loadTextureAtlasFromPlist(lua_State* tolua_S)
{
	int argc = 0;
	dragonBones::DBCCFactory* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_dragonbones_DBCCFactory_loadTextureAtlasFromPlist'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
			return 0;
		dragonBones::ITextureAtlas* ret = cobj->loadTextureAtlasFromPlist(arg0, "");
		object_to_luaval<dragonBones::ITextureAtlas>(tolua_S, "db.ITextureAtlas", (dragonBones::ITextureAtlas*)ret);
		return 1;
	}
	if (argc == 2)
	{
		...
		if (!ok)
			return 0;
		dragonBones::ITextureAtlas* ret = cobj->loadTextureAtlasFromPlist(arg0, arg1);
		object_to_luaval<dragonBones::ITextureAtlas>(tolua_S, "db.ITextureAtlas", (dragonBones::ITextureAtlas*)ret);
		return 1;
	}
	CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "loadTextureAtlasFromPlist", argc, 1);
	return 0;
...
int lua_register_dragonbones_DBCCFactory(lua_State* tolua_S)
{
	...
	tolua_function(tolua_S, "loadTextureAtlasFromPlist", lua_dragonbones_DBCCFactory_loadTextureAtlasFromPlist); 
